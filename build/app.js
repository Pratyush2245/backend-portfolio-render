...
const blogRequest_route_1 = __importDefault(
  require("./routes/blogRequest.route")
);
...
exports.app.use(
  (0, cors_1.default)({
    origin: [
      "https://www.pratyushbhattacharya.in",
      "https://pratyushbhattacharya.in",
      "https://pratyushbhattacharya.vercel.app",
    ],
    credentials: true,
  })
);
